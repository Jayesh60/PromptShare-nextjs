      ...
      {session? (
        ...
        <div className="flex justify-center items-center text-gray-600">
          ...
          <div className="flex-grow">
            <h2 className="text-gray-900 text-lg title-font font-medium mb-3">SIGN IN FIRST</h2>
            <p className="leading-relaxed text-base">To post something, you should sign-in first and enjoy the PromptShare's potential.</p>
